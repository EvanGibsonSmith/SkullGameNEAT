...
// NOTE: this came from another project (bananagrams_solver) TODO link here
...
public class MultiSet<E> implements Iterable<E> {
    ...
    public E remove(E obj) {
        ...
        --size;
        return obj; // TODO modified from bananagrams_solver, may want to keep them consistent? Returning this is really nice generally for the data structure
    }
